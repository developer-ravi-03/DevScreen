          ...
          <button type="button" onClick={() => setSelectedRole("candidate")} className="text-left">
            <Card className={[
              ...
              selectedRole === "candidate"
                ? "border-indigo-500 bg-indigo-500/10 ring-2 ring-indigo-500/20 shadow-lg shadow-indigo-950/10"
              ...
              <CardContent className="p-6 space-y-4">
                <div className="grid size-12 place-items-center rounded-xl bg-indigo-400/10">
                  <Code2Icon className="size-6 text-indigo-600 dark:text-indigo-200" />
                </div>
                <div>
