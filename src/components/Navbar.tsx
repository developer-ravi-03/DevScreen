          ...
          <SignedIn>
            ...
            <div className="flex md:hidden items-center">
              ...
              <div className="relative group">
                ...
                {/* <div className="absolute -inset-0.5 bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 dark:from-cyan-500 dark:via-emerald-500 dark:to-teal-500 rounded-2xl opacity-30 group-hover:opacity-60 animate-pulse transition-opacity duration-300" /> */}
